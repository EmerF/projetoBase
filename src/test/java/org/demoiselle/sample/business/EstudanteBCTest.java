...
import org.demoiselle.sample.business.EstudanteBC;
...
public class EstudanteBCTest {
	...
	public void testInsert() {
		...
		Estudante estudante = new Estudante(new Date(),Integer.valueOf(1),null,null,null,Long.valueOf(1),"nome",new Date(),null);
	...
	public void testUpdate() {
		...
		// estudante2.setUmaPropriedade("novo valor");
		...
		// alterar para tratar uma propriedade existente na Entidade Estudante
		// assertEquals("novo valor", estudante3.getUmaPropriedade());
	}
